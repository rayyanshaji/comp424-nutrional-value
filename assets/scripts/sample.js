function autocomplete(inp, arr) {
  ...
  inp.addEventListener("input", function(e) {
      ...
      method: 'GET',
       ...
       $.get('https://trackapi.nutritionix.com/v2/search/instant', {query: inp.value , detailed: true}, lstofresults)
            ...
            for (i = 0; i < foodindex.length; i++) {
                ...
                if (happylist.common[i].food_name.substr(0, val.length).toUpperCase() == val.toUpperCase()) {
                  ...
                  b.addEventListener("click", function (e) {
                      ...
                      selectedfoods = inp.value;
                               
                    isLargeNumber = foodindex.findIndex(function(item, i){
                      return item.food_name === inp.value
                    });
